...
<body class="text-center"> <!--style="background:linear-gradient(#ecbab2 , #cfa299,#c27872)-->
    ...
    <form class="form-signin" method="post" action="check_login.php" role="login">
      <img class="mb-4" src=".........." alt="" width="100" height="100"  border="1">
      ...
      <button class="btn btn-lg btn-block font2" style="background-color: #6495ED" type="submit">เข้าสู่ระบบ</button><br>
      <center><a href="forget_pass23.php"><font color="red">ลืมรหัสผ่าน ?</font></a></center>
