...
<div class="container" style="margin-top: 250px">
      ...
      <div class="py-5 text-center">
        ...
        <h2 class="font2">สมัครมาชิก</h2>

      </div>

      <form method="post" action="add_regis.php">
        ...
        <div class="col-md-8 order-md-1" style="margin-left : 150px">
         <!-- <h4 class="mb-3">Billing address</h4> -->
          ...
          <div class="row">
            ...
            <hr class="mb-4">
            <button class="btn btn-lg btn-block font2" style="background-color: #6495ED" type="submit">ยืนยันสมัครสมาชิก</button>
          </form><br><br><br><br><br>
        </div>
        </form>
      </div>
