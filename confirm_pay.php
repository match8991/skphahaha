...
if ($_FILES["Bill_photo"]["error"] > 0) {
    ...
    if (move_uploaded_file($_FILES["Bill_photo"]["tmp_name"], "Bill_photo/" . $_POST["Order_ID"] . ".jpg")) {
        echo "" . "<br>";
    } else {
...
$sql = "INSERT INTO bill (Bill_acname,Bill_date,Bill_amount,Bill_time) VALUES ('" . $Bill_acname . "','" . $Bill_date . "','" . $Bill_amount . "','" . $Bill_time . "')";
$conn->query($sql);
...
?>
                        ...
                        <p>ชำระเงินเรียบร้อยแล้ว<br> <a href="show_order.php">รายการสั่งซื้อ</a> </p>
